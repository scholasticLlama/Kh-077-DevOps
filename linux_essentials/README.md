...
student@CsnKhai:~$cat link2
Nothing was changed.

#rename the hard link file to hard_lnk_labwork2; 
```
<img id="theImage" src="./pictures/rename_hard.jpg">

```console
#rename the soft link file to symb_lnk_labwork2;
```
<img id="theImage" src="./pictures/rename_soft.jpg">

```console 
#then delete the labwork2. What changes have occurred and why?
The hard link still exists, unlike soft link.
```
<img id="theImage" src="./pictures/delete_link.jpg">
